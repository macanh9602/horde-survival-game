...
namespace Watermelon
{
    public class SavePresetsWindow : EditorWindow
    {
        ...
        private void DrawElement(Rect rect, int index, bool isActive, bool isFocused)
        {
            ...
            if (GUI.Button(workRect, "Activate"))
            {
        ...
        private void ActivatePreset(string name)
        {
            ...
            {
                Debug.LogError(string.Format("[Save Presets]: Preset with NameGear {0} doesn’t  exist!", name));
        ...
        {
            if (index >= 0 && index < savePresets.Count)
            {
                // Delete preset file
        ...
        private void AddNewPreset(string name)
        {
            ...
            {
                Debug.LogError("[Save Presets]: Preset NameGear can't be empty!");
            ...
            {
                Debug.LogError(string.Format("[Save Presets]: Preset with NameGear {0} already exist!", name));
