...
namespace Watermelon
{
    public static class SaveController
    {
        ...
        //method check hash available in save
        public static bool IsFirstTimeSetUpGame(string hash)
        {
            //check hash.GetHashCode() available in save
            bool IsHashInit = globalSave.checkHashAvailable(hash.GetHashCode());
            return !IsHashInit;
        }
